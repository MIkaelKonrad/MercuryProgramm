...
class Runge_Kutta:
    ...
    def step(self,t):
        ''' calculating one step of the iterative process '''
        ...
        [k_1_v,k_1_a] = self.System.F(p_1,v_1,t)
        coeff = self.h/2
        [k_2_v,k_2_a] = self.System.F(p_1 + k_1_v * coeff , v_1 + k_1_a * coeff, t + coeff)
        [k_3_v,k_3_a] = self.System.F(p_1 + k_2_v * coeff , v_1 + k_2_a * coeff, t + coeff)
        [k_4_v,k_4_a] = self.System.F(p_1 + k_3_v * self.h , v_1 + k_3_a * self.h, t+ self.h )
